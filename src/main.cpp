...
const string strMessageMagic = "dirgecoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // dirgecoin: 1 days
static const int64 nTargetSpacing = 600; // dirgecoin: 10 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal dirgecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "dirgecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "This is the day people started shouting DirgeCoin!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
